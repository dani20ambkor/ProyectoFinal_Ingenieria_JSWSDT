...
public class ReporteProductos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox_Productos.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "SELECCIONE", "GENERAL", "CÓDIGO", "TIPO", "MARCA" }));
    ...
    public void imprimirReporte() throws HeadlessException {
        ...
        try {
            ...
            if (jComboBox_Productos.getSelectedItem().equals("GENERAL")) {
                ...
                JasperReport reporte = JasperCompileManager.compileReport("src\\Reportes\\rptProductosCodigo.jrxml");
            ...
            if (jComboBox_Productos.getSelectedItem().equals("MARCA")) {
                ...
                JasperReport reporte = JasperCompileManager.compileReport("src\\reportes\\rptProductosMarca.jrxml");
                JasperPrint imprimir = JasperFillManager.fillReport(reporte, parametros, cn);
                JInternalFrame frame = new JInternalFrame("Reporte");
                frame.getContentPane().add(new JRViewer(imprimir));
                frame.pack();
